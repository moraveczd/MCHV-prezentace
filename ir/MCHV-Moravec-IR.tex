...
\frame{
	...
	\end{itemize}
	\end{itemize}
	\adjincludegraphics[width=320pt,valign=t]{../img/elmag.png}
	\vfill
}
...
\frame{
	...
	\adjincludegraphics[width=320pt,valign=b]{../img/elmag.png}
	\vfill
}
...
\frame{
	\frametitle{}
	\vfill
	\adjincludegraphics[width=320pt,valign=t]{../img/elmag-spek.png}
	\vfill
}
...
\frame{
	...
	\item $\nu$ - frekvence vibrace; k - silová konstanta; $\mu$ - redukovaná hmotnost; $m_1,m_2$ - hmotnosti atomů
...
\frame{
	...
	\end{itemize}
	\begin{figure}
	\includegraphics[scale=0.4]{../img/water-vibrations.png}

	a,b) valenční vibrace; c) deformační vibrace
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
	\includegraphics[width=10cm]{../img/point-group.png}
	\end{center}
	\vfill
}
...
\frame{
	\frametitle{}
	\begin{center}
		\includegraphics[width=0.9\textwidth]{../img/Dnh.jpg}
	\end{center}
}
...
\frame{
	\frametitle{}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{../img/Al-H2O.png}
	\end{center}
}
...
\frame{
	...
	\item nejběžnější zdroj záření pro FT-IR spektrometry
	\end{itemize}
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=2.5cm,valign=l]{../img/globar.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\item Skládá se z beamsplitteru a dvou zrcadel.\footnote[frame]{\url{http://blockeng.com/technology/ftirtechnology.html}}
...
\frame{
	...
	\item pyroelektrický detektor (krystal, po dopadu záření dojde k jeho ohřátí a tím vzniku elektrického napětí na povrchu krystalu)
	\end{itemize}
	\item \emph{MCT}
	\begin{itemize}
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{../img/detector.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{center}
		\adjincludegraphics[width=0.5\textwidth]{../img/IFS-125HR.jpg}
	\end{center}
	\vfill
}

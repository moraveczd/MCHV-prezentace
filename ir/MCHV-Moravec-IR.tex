...
\frame{
	\frametitle{}
	\vfill
	\begin{alertblock}{Molekulová spektroskopie}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.6\textwidth]{../img/elmag.png}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.6\textwidth]{../img/elmag-spek.png}
...
\frame{
	...
	\item \textit{Silová konstanta vazby} (k) - závisí především na pevnosti (tuhosti) vazby a souvisí s vazebnou energií a řádem vazby.
	...
	\end{center}
	\vfill
	\footnotetext{\href{https://scienceworld.wolfram.com/physics/Two-BodyProblem.html}{Two-Body Problem}}
}
...
\frame{
	...
	\begin{alertblock}{Počet normálních vibrací}
		je roven počtu vibračních stupňů volnosti. Pro nelineární  molekulu o N atomech je počet vibrací roven 3N-6, u lineární je to 3N-5.
	\end{alertblock}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\includegraphics[width=.7\textwidth]{../img/point-group.png}
	\end{figure}
	\vfill
}
...
\frame{
	\frametitle{}
	\begin{figure}
		\includegraphics[width=0.9\textwidth]{../img/ammonia.jpg}
...
\frame{
	\frametitle{}
	\begin{figure}
		\includegraphics[width=0.5\textwidth]{../img/Methan.png}
	\end{figure}
}
...
\frame{
	\frametitle{}
	\begin{figure}
		\includegraphics[width=0.5\textwidth]{../img/Al-H2O.png}
...
\frame{
	\frametitle{}
	\vfill
	\begin{alertblock}{Výběrové pravidlo}
	...
	\begin{itemize}
	\item Při absorpci dochází k přechodu na vyšší vibrační energetickou hladinu, čemuž odpovídá zvýšení amplitudy vibrace.
	\item Absorpcí infračerveného záření molekulami vznikají pásová spektra.
	\end{itemize}

	\vspace{5mm}

	\begin{alertblock}{Intenzita pásů}
		Intenzita absorpčních pásů je úměrná druhé mocnině změny dipólového momentu.
	\end{alertblock}
	\vfill
}
...
\frame{
	...
	\item Nedisperzní – využívají optické filtry místo monochromátoru.
...
\frame{
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				\item \emph{Nernstova lampa} – lampa s žhavenou keramickou tyčinkou (oxidy vzácných zemin, \ce{CeO2 nebo ZrO2})
				\item \emph{Globar}
				\begin{itemize}
...
\section{Měřicí techniky}
\subsection{FT--IR}
\frame{
	\frametitle{}
	\vfill
	\begin{itemize}
	\item  Nejběžnější měřicí technika
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.6\textwidth]{../img/ftir.png}
...
\frame{
	\frametitle{}
	\vfill
	\adjincludegraphics[height=.85\textheight]{../img/tensor.png}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
	\item Nujol - směs alkanů s dlouhým řetězcem.
	\end{itemize}
	\adjincludegraphics[height=.85\textheight]{../img/nujol.png}
	\vfill
}
...
\frame{
	...
	\item Protože v plynném skupenství existují pouze slabé interakce mezi částicemi lze pozorovat dobře rozlišenou rotační strukturu vibračních pásů.
	\end{itemize}
	\adjincludegraphics[height=.6\textheight]{../img/water.png}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.85\textheight]{../img/IFS-125HR.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\item Vzorek se přitlačí vysokým tlakem k měřicímu krystalu, dochází k úplnému odrazu\footnote[frame]{\href{https://www.youtube.com/watch?v=O4kujZQ8YgA}{Optické kabely – Tomáš Tyc}}
	\item Do vzorku proniká evanescentní vlna do hloubky přibližně 0,5 - 5 $\mu$m
	\end{itemize}
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.7\textwidth]{../img/ATR.png}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.65\textheight]{../img/Atr-bic.jpg}
		\caption*{Pomocí ATR lze měřit i objemné předměty}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{center}
		\begin{tabular}{|p{3cm}|c|p{5cm}|}
			...
			\hline
			AMTIR (speciální skla pro IR) & 2,5 & Odolné vůči kyselým roztokům \\
			\hline
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.7\textwidth]{../img/irras.png}
...
\frame{
	...
	\begin{itemize}
		...
		\item Tuto metodu lze využít i k real-time studiu katalytických dějů na povrchu katalyzátoru.\footnote[frame]{\href{https://pubs.rsc.org/en/content/articlelanding/2024/ey/d4ey00088a}{Exploring opportunities in operando DRIFTS and complementary techniques for advancing plasma catalysis}}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.75\textwidth]{../img/DRIFTS.jpg}
		\caption*{DRIFTS modul\footnote[frame]{Zdroj: \href{https://doi.org/10.1016/j.esci.2025.100437}{A comprehensive review of diffuse reflectance infrared Fourier transform spectroscopy (DRIFTS) techniques in protonic ceramic cells (PCCs): Current status and future perspective}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Photoacoustic Fourier Transform Infrared Spectroscopy - kombinace FT-IR a fotoakustické spektroskopie.\footnote[frame]{\href{https://doi.org/10.1016/j.wasman.2015.02.029}{FTIR–PAS: A powerful tool for characterising the chemical composition and predicting the labile C fraction of various organic waste products}}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{itemize}
				...
				\item Obraz vzorku je snímán pomocí interakce velmi tenkého hrotu s povrchem vzorku.
...
\frame{
	...
	\item Plyny vznikající během degradace vzorku vedeme do měřicí cely a pomocí IR spektroskopie stanovíme jejich složení
	\item Během transportu plynů z pece do měřicí cely dochází k velkému zředění plynu, proto je nutné používat citlivější detektory (MCT)
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=.65\textwidth]{../img/tg-irFoto.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=.65\textwidth]{../img/tg-ir.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\item Méně citlivé než GC/MS, ale umožňuje rozlišit izomery, které poskytují podobná MS spektra.
...
\frame{
	\frametitle{}
	\vfill
	\begin{alertblock}{Kvantitativní analýza}
		využívá Lambert-Beerův zákon, nejčastěji se pracuje metodou kalibrační křivky.
	\end{alertblock}
...
\frame{
	...
	\item FT-IR lze využít i pro odhad stáří nebo stupně degradace některých organických materiálů.
	...
	\begin{columns}
		\begin{column}{.58\textwidth}
			\begin{itemize}
				...
				\item Kapaliny je možné analyzovat pomocí průtočné měřicí cely.
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.7\textheight]{../img/C-F-wax.jpg}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.7\textheight]{../img/FTIR-roots.jpg}
...
\frame{
	...
	\vfill
	\begin{itemize}
	\item IR spektroskopii lze využít ke studiu biologických systémů, tzn. lipidů, proteinů, peptidů, biomembrán, nukleových kyselin, tkání, buněk, atd.
	\item U fosfolipidů lze stanovit konformaci řetězce a tím získat informace o jejich uspořádání v membráně.
...
\frame{
	...
	\item IR spektra lze využít i pro diagnostiku nádorů, např. sledováním závislosti polohy pásu deformační vibrace methylenové skupiny na tlaku lze odlišit zdravou a nádorovou tkáň
	\end{itemize}
...
\frame{
	...
	\begin{itemize}
		\item IR spektrum je otisk prstu molekuly.
		\item IR spektroskopie měří vibrace chemických vazeb.
		\item Poloha pásu závisí na tuhosti vazby a hmotnosti atomů.
		\item Pouze vibrace měnící dipólový moment jsou IR aktivní.
		\item FT-IR je současný standard infračervené spektroskopie.
		\item ATR je nejčastější experimentální uspořádání.
		\item IR spektroskopie je rychlá, nedestruktivní a univerzální analytická metoda.
	\end{itemize}
	\vfill
}

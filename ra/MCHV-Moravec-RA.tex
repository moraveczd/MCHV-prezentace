...
\subtitle{C6250 Metody chemické výzkumu}
...
\frame{
	...
	\item Při nepružném rozptylu naopak k výměně energie mezi zářením a hmotou dochází. Tento jev byl popsán v roce 1928 Sirem Chandrasekhara Venkata Ramanem. Pojmenován byl po objeviteli \em{Ramanův efekt} nebo \em{Smekalův-Ramanův efekt}. Za tento objev obdržel sir Raman Nobelovu cenu za fyziku v roce 1930.\footnote[frame]{\url{http://www.nobelprize.org/nobel_prizes/physics/laureates/1930/raman-lecture.pdf}}
\end{itemize}
	\vfill
}
...
\frame{
	...
	\item Aby byla vibrace viditelná v IR spetroskopii, musí během ní docházet ke změně vektoru dipólmomentu molekuly.
	\item Aby byla vibrace viditelná v Ramanově spetroskopii, musí během ní docházet ke změně \emph{tensoru polarizovatelnosti} molekuly.
...
\frame{
	...
	\item Jde o koherentní a monochromatický zdroj záření.
	\begin{itemize}
	...
	\begin{center}
	\begin{tabular}{cc}
	\includegraphics[height=20mm]{../img/laser.png} &
	\includegraphics[height=20mm]{../img/laser-principle.png}\\
	\end{tabular}
	\end{center}
	\vfill
}
...
\frame{
	...
	\item Skládá se z beamsplitteru a dvou zrcadel.
	\item Jedno ze zrcadel se pohybuje, konstantní rychlostí, po dráze kolmé k jeho ploše.\footnote[frame]{\url{http://blockeng.com/technology/ftirtechnology.html}}
	\end{itemize}
	\begin{center}
		\adjincludegraphics[width=0.35\textwidth]{../img/Michelson_Interferometer.jpg}
	\end{center}
}
...
\frame{
	...
	\vfill
	\begin{itemize}
	\item Nejčastěji se využívá \emph{difrakční mřížka}.\footnote[frame]{\href{https://www.wikiskripta.eu/w/Optická_mřížka}{Optická mřížka}}
	...
	\item Hustota vrypů na mřížce je řádově stovky vrypů na centimetr.
...
\frame{
	...
	\begin{itemize}
	\item Fotonásobič\footnote[frame]{\url{https://en.wikipedia.org/wiki/Photomultiplier}}$^,$\footnote[frame]{\href{http://micro.magnet.fsu.edu/primer/flash/photomultiplier/}{Animace fotonásobiče}}
	\end{itemize}
	\item CCD - \textbf{C}harged \textbf{C}oupled \textbf{D}evice\footnote[frame]{\url{https://en.wikipedia.org/wiki/Charge-coupled_device}}
	\begin{itemize}
	...
	\end{itemize}
	\begin{figure}
		\includegraphics[height=28mm]{../img/Photomultipl.jpg}
		\includegraphics[height=28mm]{../img/CCD.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
	\begin{center}
	\adjincludegraphics[width=50mm]{../img/raman-microscope.jpg}
	\\
	\tiny \url{https://commons.wikimedia.org/wiki/File:InVia_Raman_microscope_-_March_2008.jpg}
	\end{center}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\item Mechanismus není dosud detailně objasněn, pravděpodobně jde o o zesílení vlivem elektrického pole substrátu.
	\item Využití SERS v praxi
	\begin{itemize}
	\item Detekce extrémně malých množství chemikálií.
	\item Analýza vzácných uměleckých děl - pro analýzu stačí méně než $\mu$g vzorku.
	\end{itemize}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\includegraphics[height=.6\textheight]{../img/sers.png}
		\caption*{Princip SERS}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
	\adjincludegraphics[width=50mm]{../img/ROA_pinene.png}
	\\
	\tiny \url{https://en.wikipedia.org/wiki/File:ROA_pinene.PNG}
	\end{center}
	\vfill
}
...
\frame{
	...
	\item Na obrázku jsou buňky primátů obarvené fluorescenčním barvivem DAPI a příslušné Ramanovo spektrum.\footnote[frame]{\href{http://www.chemagazin.cz/5-2019-(Farmacie-a-biotechnologie)-C1047/}{CHEMAGAZIN, 2019, 5, 22-23}}
